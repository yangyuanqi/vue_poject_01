<template>
  <div>
    ...
    <el-card>
      ...
      <!--修改-->
      <el-dialog title="详情" :visible.sync="viewDialogVisible" width="50%" @close="viewDialogVisible=false">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 获取用户数据
      async getAdminList() {
        const { data: res } = await this.$http.get('auth/adminlog', {
